...
import DrumSVG from '#assets/icons/drum.svg'
...
import LiebevollJetztSVG from '#assets/icons/liebevoll.jetzt.svg'
...
import QuestSVG from '#assets/icons/quest.svg'
import ShopSVG from '#assets/icons/shop.svg'
import StaffSnakeSVG from '#assets/icons/staff-snake.svg'
    ...
    case 'penta':
      return `<svg width='33' height='44' viewBox='0 0 35 45' xmlns='http://www.w3.org/2000/svg'>
          ...
          <g opacity='.15' transform='matrix(1.0769 0 0 -1.0769 -272.731 48.23)'>
            <path
              d='M276.75 42h-14.5L255 28.668 269.5 3 284 28.668zm-.595-1l6.701-12.323L269.5 5.033l-13.356 23.644L262.845 41z'
              fill='#231f20'
            />
          </g>
        </svg>`
